...
<div class="title3">财务金融模块<span style="float:right;"><a href="http://ici.szu.edu.cn/edupage2.asp?id=490"> 
...
<a href="edupage2?id=6">素质提升模块</a>
    ...
    <tbody>
        ...
        <tr>
            <td bgcolor="#999999" rowspan="5" width="72"><strong>财务金融模块</strong></td>
            <td width="324">面向文化产业的金融创新</td>
            <td width="149"><a href="http://ici.szu.edu.cn/teamnews_view.asp?id=498">张扬 博士</a></td>
        </tr>
        <tr>
            <td width="324">文化产业项目与私募股权投资</td>
            <td width="149"><a href="http://ici.szu.edu.cn/teamnews_view.asp?id=498">张扬 博士</a></td>
        </tr>
        <tr>
            <td>财务会计学</td>
            <td width="149"><a href="http://ici.szu.edu.cn/teamnews_view.asp?id=481">初大智 博士</a></td>
        </tr>
        <tr>
            <td>公司理财</td>
            <td width="149"><a href="http://ici.szu.edu.cn/teamnews_view.asp?id=481">初大智 博士</a></td>
