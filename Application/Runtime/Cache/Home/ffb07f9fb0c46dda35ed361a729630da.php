...
<div class="title3">特约研究员<span style="float:right;"><a href="javascript:history.go(-1)"> 
...
<table width="920" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <div style="float:left; width:100px; height:30px; line-height:30px; text-align:center;">
        <a href="teamnews_view.asp?id=3519">胡野秋</a>
    </div>
	
    <div style="float:left; width:100px; height:30px; line-height:30px; text-align:center;">
        <a href="teamnews_view.asp?id=3518">郑建平</a>
    </div>
	
    <div style="float:left; width:100px; height:30px; line-height:30px; text-align:center;">
        <a href="teamnews_view.asp?id=3517">韩 晗</a>
    </div>
	
    <div style="float:left; width:100px; height:30px; line-height:30px; text-align:center;">
        <a href="teamnews_view.asp?id=3497"> 毛少莹</a>
    </div>
	
    <div style="float:left; width:100px; height:30px; line-height:30px; text-align:center;">
        <a href="teamnews_view.asp?id=3496">李若飞</a>
    </div>
	
    <div style="float:left; width:100px; height:30px; line-height:30px; text-align:center;">
        <a href="teamnews_view.asp?id=3500">张武宜</a>
    </div>
